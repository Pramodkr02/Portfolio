      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-start mb-2">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-md mb-3">
              <img
                src={data.logo}
                alt={data.company}
          ...
          <h4 className="text-base font-medium text-text-secondary mb-3">
            {data.company}
          </h4>
