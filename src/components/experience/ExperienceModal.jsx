            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {data.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-2 py-1 text-xs rounded-md bg-surface-200 text-text-secondary border border-border-soft"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-surface-200 text-text-tertiary">
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/400x300?text=Certificate"; // Fallback
                  }}
                />
              </div>
